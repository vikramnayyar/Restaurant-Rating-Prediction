...
The script reads and cleans the dataset.

Also, the **locations** and **restaurant type** dictionary is saved. This is 
...
from get_data_util import analyze_data, download_dataset, extract_dict
